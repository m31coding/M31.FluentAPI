...
{
    [Fact, Priority(1)]
    public void CanExecuteFluentLambdaManyPrivateCollectionsClassTest1()
    {
    ...
    [Fact, Priority(1)]
    public void CanExecuteFluentLambdaManyPrivateCollectionsClassTest2()
    {
        Student student = CreateStudent
            .WithName("Alice")
    ...
    [Fact, Priority(1)]
    public void CanExecuteFluentLambdaManyPrivateCollectionsClassTest3()
    {
        Student student = CreateStudent
            .WithName("Alice")
    ...
    [Fact, Priority(1)]
    public void CanExecuteFluentLambdaManyPrivateCollectionsClassTest4()
    {
        Student student = CreateStudent
            .WithName("Alice")
