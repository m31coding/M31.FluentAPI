...
internal class TestDataProvider : IEnumerable<object[]>
{
    private readonly List<object[]> testClasses =
        Filter(new string[] { "CommentedPropertiesClassAdvanced" },
            new List<object[]>
            {
                ...
                new object[] { "Abstract", "DocumentationComments", "CommentedMethodsClass", "Student" },
                new object[] { "Abstract", "DocumentationComments", "CommentedPropertiesClass", "Student" },
                new object[] { "Abstract", "DocumentationComments", "CommentedPropertiesClassAdvanced", "Student" },
                ...
                new object[] { "Abstract", "FluentLambdaCollectionClass", "Student|Address" },
                ...
                new object[] { "Abstract", "GenericClassPrivateDefaultConstructor", "Student" },
                ...
                new object[] { "Abstract", "InheritedClassPrivateSetters", "Student|Person" },
                new object[] { "Abstract", "InheritedClassProtectedMembers", "Student|Person" },
                ...
                new object[] { "Abstract", "SkippableForkMembersClass", "Student" },
                ...
                new object[] { "Abstract", "SkippableTwoLoopsClass", "Student" },
                new object[] { "Abstract", "ThreeMemberClass", "Student" },
                new object[] { "Abstract", "ThreeMemberRecord", "Student" },
                new object[] { "Abstract", "ThreeMemberRecordPrimaryConstructor", "Student" },
